...
p1 = determine_plot_c((gene_sig %>% filter(if_all(paste0(compare_list[2],".fc"), ~ !is.na(.x))))$symbol,
                      paste0("Significantly Upregulated"))
p2 = determine_plot_c((gene_nonsig %>% filter(if_all(paste0(compare_list[2],".fc"), ~ !is.na(.x))))$symbol,
...
l1 = (gene_sig %>% filter(if_all(paste0(compare_list[2],".fc"), ~ !is.na(.x))))
l2 = (gene_nonsig %>% filter(if_all(paste0(compare_list[2],".fc"), ~ !is.na(.x))))
determine_stats_c(l1,l2)
